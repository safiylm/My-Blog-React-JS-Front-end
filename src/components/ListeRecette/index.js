        ...
        <div className="page-blog-recette1">
            ...
            <div className="div-les-articles">
                <div className="div-un-article">
                    <img id="image-article" src="https://static.wixstatic.com/media/f3932a74408c4727a7b717f927088f22.jpg/v1/fill/w_460,h_345,fp_0.50_0.50,q_90,enc_auto/f3932a74408c4727a7b717f927088f22.jpg" />
                    <div className="div-un-article-texte" >
                        ...
                        <div className="titre-desciption">
                            <h1>Pain à pétrir : la recette</h1>
                            <p>
                ...
                <div className="div-un-article">
                    <img id="image-article" src="https://static.wixstatic.com/media/b381154bcd8c4c38b5896efd508b6e49.jpg/v1/fill/w_460,h_345,fp_0.50_0.50,q_90,enc_auto/b381154bcd8c4c38b5896efd508b6e49.jpg" />
                    <div className="div-un-article-texte" >
                        <div className="div-personna">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                        ...
                        <div className="titre-desciption">
                            <h1> 5 recettes pour petits budgets</h1>
                            <p>
                                Créez un sous-titre de post de blog accrocheur qui résume en quelques phrases votre post et qui motivera vos lecteurs à continuer à lire....
                            </p>
                        </div>
                ...
                <div className="div-un-article">
                    <img id="image-article" src="https://static.wixstatic.com/media/bbed4f2c072f437b98b41824881aa51a.jpg/v1/fill/w_460,h_345,fp_0.50_0.50,q_90,enc_auto/bbed4f2c072f437b98b41824881aa51a.jpg" />
                    <div className="div-un-article-texte" >
                        <div className="div-personna">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                        ...
                        <div className="titre-desciption">
                            <h1>Des présentations faciles et alléchantes</h1>
                            <p>
                                Créez un sous-titre de post de blog accrocheur qui résume en quelques phrases votre post et qui motivera vos lecteurs à continuer à lire....
                            </p>
                        </div>
                ...
                <div className="div-un-article">
                    <img id="image-article" src="https://static.wixstatic.com/media/a27d24_37c143133ff84d439d3bb77251b91a7a~mv2.jpg/v1/fill/w_460,h_345,fp_0.50_0.50,q_90,enc_auto/a27d24_37c143133ff84d439d3bb77251b91a7a~mv2.jpg" />
                    <div className="div-un-article-texte" >
                        <div className="div-personna">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                        ...
                        <div className="titre-desciption">
                            <h1>La recette du Paris-Brest inratable</h1>
                            <p>
                                Créez un sous-titre de post de blog accrocheur qui résume en quelques phrases votre post et qui motivera vos lecteurs à continuer à lire....
                            </p>
                        </div>
                ...
                <div className="div-un-article">
                    <img id="image-article" src="https://static.wixstatic.com/media/c18e117763dc4b60ba891139fa28c8d7.jpg/v1/fill/w_460,h_345,fp_0.50_0.50,q_90,enc_auto/c18e117763dc4b60ba891139fa28c8d7.jpg" />
                    <div className="div-un-article-texte" >
                        <div className="div-personna">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                        ...
                        <div className="titre-desciption">
                            <h1>7 salades pour pimenter votre été </h1>
                            <p>
                                Créez un sous-titre de post de blog accrocheur qui résume en quelques phrases votre post et qui motivera vos lecteurs à continuer à lire....
                            </p>
                        </div>
