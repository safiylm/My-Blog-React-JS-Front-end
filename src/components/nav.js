...
function Nav() {
    ...
    const langueEN =()=>{
        ...
        document.location.href =  document.location.protocol + '//' + document.location.host + document.location.pathname +"?lang=en";
    }

    const langueFR =()=>{
        localStorage.setItem('lang', 'fr');
        document.location.href =  document.location.protocol + '//' + document.location.host + document.location.pathname +"?lang=fr";
    }

    const langueTR =()=>{
        localStorage.setItem('lang', 'tr');
        document.location.href =  document.location.protocol + '//' + document.location.host + document.location.pathname +"?lang=tr";
    }
