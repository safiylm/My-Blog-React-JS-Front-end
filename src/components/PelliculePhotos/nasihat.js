    ...
    return (
        <div className="App">
            ...
            <div className="container-publications-photos nasihat">
                ...
                <div id="text1" className="une-publication">
                    <img src={nature} />
                    <div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text1").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text1").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>

                <div id="text2" className="une-publication">
                    ...
                    <div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text2").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text2").classList.add("expand")} className="readmore">Read More </button>
                    </div>

                </div>

                <div id="text3" className="une-publication">
                    ...
                    <div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text3").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text3").classList.add("expand")} className="readmore">Read More </button>
                    </div>

                </div>

                <div id="text4" className="une-publication">
                    <img src="https://images.pexels.com/photos/12801958/pexels-photo-12801958.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text4").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text4").classList.add("expand")} className="readmore">Read More </button>
                    </div>  </div>

                <div id="text5" className="une-publication">
                    <img src="https://images.pexels.com/photos/20513314/pexels-photo-20513314/free-photo-of-osorno-sunset.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div>  <div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text5").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text5").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>


                <div id="text6" className="une-publication">
                    <img src="https://images.pexels.com/photos/19989958/pexels-photo-19989958/free-photo-of-a-view-of-the-sky-from-above-a-forest.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
                    <div> <div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text6").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text6").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>

                <div id="text7" className="une-publication">
                    <img src="https://images.pexels.com/photos/4492596/pexels-photo-4492596.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div>  <div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text7").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text7").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>

                <div id="text8" className="une-publication">
                    <img src="https://images.pexels.com/photos/19824001/pexels-photo-19824001/free-photo-of-vaduz-city-by-snowed-mountains.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div> <div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text8").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text8").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>

                <div id="text9" className="une-publication">
                    <img src="https://images.pexels.com/photos/258196/pexels-photo-258196.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div><div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text9").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text9").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>

                <div id="text10" className="une-publication">
                    <img src="https://images.pexels.com/photos/20761525/pexels-photo-20761525/free-photo-of-a-woman-sitting-at-a-cafe-in-hoi-an.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div> <div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text10").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text10").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>

                <div id="text11" className="une-publication">
                    <img src="https://images.pexels.com/photos/20004051/pexels-photo-20004051/free-photo-of-a-person-holding-a-bouquet-of-red-tulips-in-front-of-a-green-light.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div> <div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text11").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text11").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>

                <div id="text12" className="une-publication">
                    <img src="https://images.pexels.com/photos/12509079/pexels-photo-12509079.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div> <div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text12").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text12").classList.add("expand")} className="readmore">Read More </button>
                    </div>
                </div>


                <div id="text13" className="une-publication">
                    <img src="https://images.pexels.com/photos/1447424/pexels-photo-1447424.jpeg?auto=compress&cs=tinysrgb&w=1200" />
                    <div> <div className="date">02.03.2023</div>
                        ...
                        <button id="btn-fermer" onClick={() => document.getElementById("text13").classList.remove("expand")}>Fermer</button>

                        <button onClick={() => document.getElementById("text13").classList.add("expand")} className="readmore">Read More </button>
                    </div> </div>
